...
namespace AquariumCalculator.Services
{
  ...
  /// 
  /// </summary>
  public class MainPanelGlassStrengthConstants : IGlassStrength
  {
    ...
    static MainPanelGlassStrengthConstants()
    {
      ...
      {
        new AlfaBetaConstants(0.5, 0.0003, 0.085),
        new AlfaBetaConstants(0.666, 0.0085, 0.1156),
        new AlfaBetaConstants(1.0, 0.022, 0.16),
        new AlfaBetaConstants(1.5, 0.042, 0.26),
        new AlfaBetaConstants(2.0, 0.056, 0.32),
        new AlfaBetaConstants(2.5, 0.063, 0.35),
        new AlfaBetaConstants(3.0, 0.067, 0.37)
      };
